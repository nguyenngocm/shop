                        ...
                        <div class="card-body">
                            <form action="edit.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="<?php echo $product['name']; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name">
                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Ảnh</label>
                                    <input type="text" name="img" value="<?php echo $product['img']; ?> " class="form-control" id="exampleInputPassword1" placeholder="Img">
                                </div>
                                <div class="form-group">
